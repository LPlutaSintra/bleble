    ...
    public function execute()
    {
        ...
        $resultRedirect->setUrl($this->_redirect->getRefererUrl());
			...
			if($params['quote_id'])
			{
				...
				$sub_detail_arr['admin_id']=$admin_id;	
				if(isset($params['is_notify_customer']))
				{
				$is_notify_customer=$params['is_notify_customer'];
				$sub_detail_arr['is_customer_notify']=$is_notify_customer?$is_notify_customer:0;	
				}
				...
				{	
 				...
 				try
				 {
						...
						if($email_config['notify_customer'])
						{
									 if(isset($params['is_notify_customer']))
							{
								$this->emailHelper->sendNotifyMail($quote_id,$post_files,$editor_text,'customer');
