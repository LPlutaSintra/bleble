...
return [
    'modules' => [
        ...
        'Stripeofficial_CreditCards' => 1,
        'Stripeofficial_GiroPay' => 1,
        'Stripeofficial_IDeal' => 1,
        'Stripeofficial_InstantCheckout' => 1,
        'Stripeofficial_Przelewy' => 1,
        'Stripeofficial_SEPA' => 1,
        'Stripeofficial_SOFORT' => 1,
        'Temando_Shipping' => 1,
        'Vertex_Tax' => 1,
        'WebShopApps_MatrixRate' => 1,
        'Wstechlab_B2bRegister' => 1,
        'Wstechlab_BaseRegister' => 1,
